...
namespace Veterinary.Web.Controllers
{
    ...
    public class OwnersController : Controller
    {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            {
                //_userHelper.DeleteUserAsync(String.Empty, "The owner can't be deleted because it has related records.");
                return RedirectToAction(nameof(Index));
            }
        ...
        public async Task<IActionResult> DetailsPet(int? id)
        {
            ...
            var pet = await _dataContext.Pets
                ...
                .FirstOrDefaultAsync(o => o.Id == id.Value);        // Cuando utilizamos relaciones: FirstOrDefaultAsync
            if (pet == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> AddHistory(int? id)
        {
            ...
            var pet = await _dataContext.Pets.FindAsync(id.Value);      // FindAsync no tiene datos relacionados
            if (pet == null)
            {
                return NotFound();
            }
