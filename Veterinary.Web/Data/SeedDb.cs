...
namespace Veterinary.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Pedro José", "Cruz Guevara", "pedroincora@gmail.com", "304 210 4917", "Dg 47 74A 30", "Admin");
            var customer = await CheckUserAsync("2020", "Angela Lilinana", "Cruz Blanco", "angelalcruzb90@gmail.com", "311 526 0169", "Kra 71C 52 75", "Customer");
            ...
            string lastName, string email, string phone, string address, string role)
        {
            ...
            if (user == null)
            {
                ...
                await _userHelper.AddUserAsync(user, "pyma2012");
